...
def _parse_date_param(value: str | date | None) -> date | None:
    if value is None:
        return None
...
def _build_filters(
    *,
    ...
    from_final = _parse_date_param(from_date)
    to_final = _parse_date_param(to_date)
    from_final, to_final = _ensure_date_range(from_final, to_final, has_location)
